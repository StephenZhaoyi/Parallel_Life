...
// Split rows into blocks; each block becomes a task.
void step_tasks(Grid& cur, Grid& nxt, int blockRows) {
        static const uint8_t B[9] = {1,0,0,0,0,0,0,0,1}; // 08
    static const uint8_t S[9] = {0,0,0,0,1,0,0,0,0}; // 4
